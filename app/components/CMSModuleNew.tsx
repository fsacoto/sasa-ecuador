                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-xs text-gray-500">
                        <div>{t('cms.stock') || 'Stock'}: {item.ecuadorStock} {t('cms.units')}</div>
                      </div>
                    </div>
                  </div>
                );
                      ...
                      <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 space-y-4 border border-gray-200 shadow-sm">
                        <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-gray-700">Stock (Ecuador hub)</span>
                      </div>
                        ...
                        <div className="pt-3 border-t border-gray-200">
                          ...
                          selectedProductDetail.ecuadorStock > 0
